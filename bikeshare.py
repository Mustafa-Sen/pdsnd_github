...
def get_filters():
    ...
    city= input("Which city's data should we look for? \nYou can pick 'chicago', 'new york city', or 'washington' as your choice. Please input city name: ").lower()

    while city not in ['chicago', 'new york city', 'washington']:
        city= input("City name is not valid! You only can pick chicago, new york city, or washington as your input. Please input city name: ").lower()

    # TO DO: get user input for month (all, january, february, ... , june)
    month= input("\nGreat! Now it is time to pick your month. \nYour imput can be 'all', 'january', 'february', 'march', 'april', 'may', 'june' as your choice. Please input month name: ").lower()

    while month not in ['all', 'january', 'february', 'march', 'april', 'may', 'june']:
        month= input("Month name is not valid. You can only pick 'all', 'january', 'february', 'march', 'april', 'may', 'june' as your choice. Please input month name: ").lower()

    # TO DO: get user input for day of week (all, monday, tuesday, ... sunday)
    day= input("\nWhich day of the week you would like to see? \nYour imput can be 'all', 'monday', 'tuesday', 'wednesday', 'thursday', 'friday', 'saturday', 'sunday' \nPlease input day of week: ").lower()

    while day not in ['all', 'monday', 'tuesday', 'wednesday', 'thursday', 'friday', 'saturday', 'sunday']:
        day=input("Day name is not valid! \mYour imput can be 'all', 'monday', 'tuesday', 'wednesday', 'thursday', 'friday', 'saturday', 'sunday' \nPlease input day of week: ").lower()
...
def load_data(city, month, day):
    ...
    '''More info related to the code above can be find at https://stackoverflow.com/questions/48444373/pd-to-datetime-hours-and-seconds'''
